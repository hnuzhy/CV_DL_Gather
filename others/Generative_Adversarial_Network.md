...
* 👍**ControlNet(arxiv2023)** Adding Conditional Control to Text-to-Image Diffusion Models [[arxiv link](https://arxiv.org/abs/2302.05543)][[codes|official](https://github.com/lllyasviel/ControlNet)][`an excellent work`] [[sd-webui-controlnet: An extension for AUTOMATIC1111's Stable Diffusion web UI](https://github.com/Mikubill/sd-webui-controlnet)][[ControlNet-for-Diffusers by haofanwang](https://github.com/haofanwang/ControlNet-for-Diffusers)]
