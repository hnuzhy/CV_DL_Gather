...
* ❤**YOLOv7 (arxiv2022.07) (CVPR2023)** YOLOv7: Trainable bag-of-freebies sets new state-of-the-art for real-time object detectors [[paper link](https://arxiv.org/abs/2207.02696)][[code|official](https://github.com/WongKinYiu/yolov7)][[code|YOLOv7-Seg based on YOLOv5](https://github.com/WongKinYiu/yolov7/tree/u7/seg)][`Chien-Yao Wang`, `Alexey Bochkovskiy`, `Hong-Yuan Mark Liao`, `Taiwan + Intel`][`re-parameterized module` + `dynamic label assignment` + `trainable bag-of-freebies`][`Following the YOLOv5 project arch`]
