...
* **SparseDETR (ICLR2022)** Sparse DETR: Efficient End-to-End Object Detection with Learnable Sparsity [[openreview link](https://openreview.net/forum?id=RRGVCN8kjim)][[arxiv link](https://arxiv.org/abs/2111.14330)][[code|official](https://github.com/kakaobrain/sparse-detr)]
...
* **LiteDETR (CVPR2023)** Lite DETR : An Interleaved Multi-Scale Encoder for Efficient DETR [[paper link](https://openaccess.thecvf.com/content/CVPR2023/html/Li_Lite_DETR_An_Interleaved_Multi-Scale_Encoder_for_Efficient_DETR_CVPR_2023_paper.html)][[arxiv link](https://arxiv.org/abs/2303.07335)][[code|official](https://github.com/IDEA-Research/Lite-DETR)][`IDEA Research`, https://www.idea.edu.cn/]

* ❤**RT-DETR(CVPR2024)(arxiv2023)** DETRs Beat YOLOs on Real-time Object Detection [[paper link](https://openaccess.thecvf.com/content/CVPR2024/html/Zhao_DETRs_Beat_YOLOs_on_Real-time_Object_Detection_CVPR_2024_paper.html)][[arxiv link](https://arxiv.org/abs/2304.08069)][[code|official whole-repo](https://github.com/PaddlePaddle/PaddleDetection)][[code|official branch-repo](https://github.com/PaddlePaddle/PaddleDetection/tree/develop/configs/rtdetr)][[code|reproduced by ultralytics](https://docs.ultralytics.com/models/rtdetr/#overview)][`Baidu`, `PaddlePaddle`, `PaddleDetection`]
...
* **DAMO-YOLO(arxiv2022.11)** DAMO-YOLO: A Report on Real-Time Object Detection Design [[arxiv link](https://arxiv.org/abs/2211.15444)][[project link (github)](https://github.com/tinyvision/DAMO-YOLO)]

* **RTMDet(arxiv2022.12)** RTMDet: An Empirical Study of Designing Real-Time Object Detectors [[arxiv link](https://arxiv.org/abs/2212.07784)][[code|official](https://github.com/open-mmlab/mmdetection/tree/3.x/configs/rtmdet)][`Shanghai AI Laboratory + S-Lab, Nanyang Technological University + Tianjin University + SJTU`]
...
* **YOLO-MS(arxiv2023.08)** YOLO-MS: Rethinking Multi-Scale Representation Learning for Real-time Object Detection [[arxiv link](https://arxiv.org/abs/2308.05480)][[code|official](https://github.com/FishAndWasabi/YOLO-MS)][`Nankai University`]

* **Gold-YOLO(NIPS2023)(arxiv2023.09)** Gold-YOLO: Efficient Object Detector via Gather-and-Distribute Mechanism [[paper link](https://proceedings.neurips.cc/paper_files/paper/2023/hash/a0673542a242759ea637972f053b2e0b-Abstract-Conference.html)][[arxiv link](https://arxiv.org/abs/2309.11331)][[code|official](https://github.com/huawei-noah/Efficient-Computing/tree/master/Detection/Gold-YOLO)][`Huawei`]

* **YOLOv9(arxiv2024.02)** YOLOv9: Learning What You Want to Learn Using Programmable Gradient Information [[arxiv link](https://arxiv.org/abs/2402.13616)][[code|official](https://github.com/WongKinYiu/yolov9)][`Chien-Yao Wang`, `I-Hau Yeh` and `Hong-Yuan Mark Liao` in `Taiwan`]
