...
For codes, go straight to [**3) Implementation**](https://github.com/hnuzhy/Pose_Estimation_Depository/tree/master/PersonLab#3-implementation) in my another project. 
