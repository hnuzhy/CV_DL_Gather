...
by [`curriculum learning` (ICML2009, Yoshua Bengio)](https://dl.acm.org/doi/abs/10.1145/1553374.1553380) and can be thought of as a way to design an `adaptive curriculum`.]
